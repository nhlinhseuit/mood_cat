...
import 'package:mood_cat/screens/home_expense/widget/mood_circle.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Vòng tròn các biểu tượng cảm xúc
          const MoodCircle(),
          const SizedBox(height: 48.0),
          // Nút "Vẽ" và "Biểu tượng cảm xúc"
          // Row(
          //   mainAxisAlignment: MainAxisAlignment.center,
          //   children: [
          //     TextButton.icon(
          ...
          //     TextButton.icon(
          //       onPressed: () {
          //         // Xử lý khi nhấn nút "Biểu tượng cảm xúc"
          //         Navigator.pop(context);
          //         // TODO: Thêm logic cho nút "Biểu tượng cảm xúc"
          //       },
